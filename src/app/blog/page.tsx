        ...
        <section  className="bg-[radial-gradient(#000_1px,transparent_1px)] min-h-screen grid justify-center m-auto relative max-w-[90%] lg:max-w-[50%]" >
            ...
            <div className="relative z-20">  
                ...
                <div className="mt-10" onClick={() => showInput(true)}>
                    <div className="border shadow-md cursor-pointer p-5 text-gray-400 rounded-md cursor-pointer"><p>Escribe algo...</p></div>
                </div>
                ...
                <div>
                    <ul className="mt-10 space-y-3">
                        <li className="border-b  p-4">
                            ...
                            <div className="font-bold text-xl"><p>El poder de la gracia de Dios en la vida del hombre, un hecho sobrenatural asdkf alskdfj alskdjf laksdj flaksjdf lakjsd flaksjdf laskjdf laskjd flaskdj flaksj dflaksjd lfkasj dflkasj dflkj asfldka jsdlfkaj sldfkja sldkfj alskdfj </p></div> 
                            <div><p>Dios nos llamó a manifestar las obras del hijo y no las de la carne</p></div>
                            <div className="flex space-x-2 mt-2">
                            <HandThumbUpIcon className="w-5 h-5" />
                            <BookmarkIcon className="w-5 h-5" />
                            </div>            
                        </li>
                        <li className="border-b min-w-[330px] p-4">
                            <div className="flex justify-between items-center mb-2">
                                <p>Martin Herrera</p>
                                <p>hace 1 min</p>
                            </div>
                            <div><p>This is a reflection</p></div> 
                            <div className="flex space-x-2 mt-2">
                            <HandThumbUpIcon className="w-5 h-5" />
                            <BookmarkIcon className="w-5 h-5" />
                            </div>            
